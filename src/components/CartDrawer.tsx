  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const { data: rows, error: orderError } = await supabase.rpc("place_order", {
        ...
        _address_street: deliveryMethod === "entrega" ? street : null,
        _address_number: deliveryMethod === "entrega" ? number : null,
        _address_neighborhood:
          deliveryMethod === "entrega" ? selectedRange?.label || null : "Retirada no Local",
        _address_complement: deliveryMethod === "entrega" ? complement || null : null,
        _address_reference: deliveryMethod === "entrega" ? reference || null : null,
        _notes: notes || null,
